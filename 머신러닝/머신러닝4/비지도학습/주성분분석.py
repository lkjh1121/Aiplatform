...
# 주성분 분석을 이용해서 특성들 중에서 특볗히 주가 되는 성분을 빼내서 새로운 특성을 만든다.
# 30개의 특성에서 => 2개로 특성을 줄이자
...
# 주성분 분석없이, 악성과 양성 두 클래스에 대해서 각각 히스토그램을 그리는 방법도 있디.
fig, axes = plt.subplots(15, 2, figsize=(10, 20))
# subplot 함수는 플롯의 영역을 행과 열로 나누는 일을 한다.
# 15행과 2열로 나누고 플롯 전체의 크기는 figsize로 지정해서 10 by 20으로 키운다.
# figsize 의 정확한 단위는 성명서에 없음
# 반환값이 tuple 타입인데 fig = 플롯 크기, axes 는 축 정보이다.
# 이 정보를 이용해서 차트를 지정된 위치에 출력할 수 있다.

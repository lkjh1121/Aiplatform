...
#처음에 호출할때 네트워크로 다운로드 받는다 
#사진이 최소한 20장씩 있는 사람 정보만 다운 받자 
...
#결론 : 전체 성분으로 학습한것보다 주성분학습이 오히려 효과가 좋을 수 도 있다. 

#주성분으로 이미지 그리기 
fig, axes = plt.subplots( 2, 6, figsize=(15, 8), 
                          subplot_kw={'xticks':(), 'yticks':()}) #축을 없앤다. 

# enumerate(list) - 인덱스와 데이터로 쪼개서 
